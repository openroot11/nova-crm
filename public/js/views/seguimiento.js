      ...
      <tr class="${lead.followup_status === 'urgente' ? 'bg-error/5 hover:bg-error/10' : 'hover:bg-surface-container-low'} transition-colors">
        ...
        <td class="p-table-cell-padding text-right">
          <div class="flex justify-end flex-wrap gap-2">
            <button data-action="followup" data-id="${lead.id}" class="bg-surface-container-lowest text-on-surface hover:bg-surface-container-low border border-outline-variant px-3 py-2 rounded-lg font-bold text-body-sm font-body-sm transition-colors">${meta.label}</button>
