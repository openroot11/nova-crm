      ...
      body.innerHTML = `
        <form id="qs-form" class="space-y-5">
          <div class="relative">
            ...
            <input id="qs-cliente" required type="text" autocomplete="off" placeholder="Escribe para buscar o crear un cliente nuevo" class="w-full p-2.5 bg-surface-container-lowest border border-outline-variant rounded-md text-body-md focus:border-outline focus:ring-2 focus:ring-outline/20 outline-none transition-all" />
          ...
          <div id="qs-asesor-wrap">
            ...
            <select id="qs-asesor" required class="w-full p-2.5 bg-surface-container-lowest border border-outline-variant rounded-md text-body-md focus:border-outline focus:ring-2 focus:ring-outline/20 outline-none transition-all appearance-none cursor-pointer">
              <option value="">Cargando asesores…</option>
            </select>
          </div>
          <div>
            <label class="block text-label-bold font-label-bold text-on-surface-variant mb-1 uppercase tracking-wider">Referencia del pedido</label>
            <input id="qs-referencia" type="text" placeholder="Ej. PED 1917 o S02033 (opcional)" class="w-full p-2.5 bg-surface-container-lowest border border-outline-variant rounded-md text-body-md focus:border-outline focus:ring-2 focus:ring-outline/20 outline-none transition-all" />
          </div>
          <div>
